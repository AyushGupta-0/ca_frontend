...
export const getCategoriesAction = (token, firmId) => (dispatch) => {
  ...
  try {
    const url = `http://localhost:8080/category/getcategory/${firmId}`;
...
export const postCategoryAction = (creds, token, firmId) => (dispatch) => {
  ...
  dispatch({ type: LOADING_CATEGORIES });
  try {
    const url = `http://localhost:8080/category/createcategory/${firmId}`;
...
export const updateCategoryAction = (creds, token , firmId) => (dispatch) => {
  ...
  dispatch({ type: LOADING_CATEGORIES });
  try {
    const url = `http://localhost:8080/category/updatecategory/${firmId}/id`;
...
export const deleteCategoryAction = (categoryId, token, firmId) => (dispatch) => {
    ...
    dispatch({ type: LOADING_CATEGORIES });
    try {
      const url = `http://localhost:8080/category/deletecategory/${firmId}/id`;
