...
export default function Home1() {
  ...
  return (
      ...
      <Flex className="topsec"
        padding={{ base: "0px 8%", lg: "0px 0px 0px 13%" }}
        gap="10px"
        position="relative"
      // border={"1px solid black"}
      h={{base:"1100",md:"700px",lg:"700px"}}
      >
        <Box textAlign={{ base: "center", lg: "left" }}>
          ...
          <Flex
            alignItems="center"
            mt={{ base: "14px", lg: "35px" }}
            justifyContent={{ base: "center", lg: "flex-start" }}
          >
            <Input
              opacity=".55"
              placeholder="Try 'Trademark'"
          ...
          >
            ...
            <Flex gap="7px" opacity=".55" fontFamily="'Poppins', sans-serif">
              <Text
                padding={{ base: "5px 8px", lg: "8px 15px" }}
                fontSize={{ base: "8px", lg: "14px" }}
                borderRadius="25px"
                backgroundColor="#5F5F5F"
                color="white"
            ...
            <Text
              ...
              color="white"
            >
              <Link to="#">Accounting & Business Compilance</Link>
            </Text>
          </Flex>
        </Box>
              ...
              return (
                <article key={id} className={position}>
                  <div className="mainposition">
                    ...
                    <Button bg="white" onClick={() => setHide(style2)} className="icon" >Read More...</Button>
                    <Link to="#">
                      <Button style={hide}>Shedule A DEMO</Button>
                    </Link>
                  </div>
                </article>
              );
