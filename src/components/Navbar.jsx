...
import Company_name from "./After Login/Billing App/Company_name/Company_name";
...
export default function Navbar() {
    ...
    if (token) {
        ...
        return (
            ...
            <Box position={"sticky"} top={"0px"} style={{
                zIndex: "99999999",
            }}>
               <Flex
                h="30px"
                ...
                fontSize="14px"
                >
  <Flex alignItems="center" gap="10px" fontFamily="'Montserrat', sans-serif">
    <Link to="/">
      <svg width="18" height="14" viewBox="0 0 18 14" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M17.1818 0H0.636364C0.284375 0 0 0.284375 0 0.636364V13.3636C0 13.7156 0.284375 14 0.636364 14H17.1818C17.5338 14 17.8182 13.7156 17.8182 13.3636V0.636364C17.8182 0.284375 17.5338 0 17.1818 0ZM16.3864 2.20341V12.5682H1.43182V2.20341L0.882955 1.77585L1.66449 0.771591L2.51563 1.43381H15.3045L16.1557 0.771591L16.9372 1.77585L16.3864 2.20341ZM15.3045 1.43182L8.90909 6.40341L2.51364 1.43182L1.6625 0.769602L0.880966 1.77386L1.42983 2.20142L8.22301 7.48324C8.41837 7.63501 8.65872 7.7174 8.90611 7.7174C9.1535 7.7174 9.39384 7.63501 9.58921 7.48324L16.3864 2.20341L16.9352 1.77585L16.1537 0.771591L15.3045 1.43182Z"
          fill="white"
        />
      </svg>
    </Link>
    <Link to="#">
      <Text color="white">info.loremipsum.com</Text>
    </Link>
  </Flex>
  <Flex color="white" alignItems="center" gap="10px" padding="5px" as="b" fontFamily="'Poppins', sans-serif">
    ...
    <Text borderRight="1px solid white" paddingRight="10px">
      <Link to="#">Blog</Link>
    </Text>
    <Link to="">
      <svg width="8" height="15" viewBox="0 0 8 15" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path
          d="M6.38249 2.49002H7.79249V0.105022C7.1098 0.0340327 6.42386 -0.00101571 5.73749 2.2398e-05C3.69749 2.2398e-05 2.3025 1.24502 2.3025 3.52502V5.49001H0V8.16001H2.3025V15H5.06249V8.16001H7.35749L7.70249 5.49001H5.06249V3.78752C5.06249 3.00002 5.27249 2.49002 6.38249 2.49002Z"
          fill="white"
        />
      </svg>
    </Link>
    <Link to="">
      <svg width="17" height="13" viewBox="0 0 17 13" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        />
                ...
                <Flex  backgroundColor="#FFB91D" fontFamily="'Roboto', sans-serif" as="b" padding={{ base: "14px 8%", lg: "4px 3%" }} justifyContent="space-between" alignItems="center">
                    <Link to="/">
                        <Image src={icon} w={{ base: "78px", lg: "118px" }} />
                    </Link>
                    <Text display={{ base: "none", lg: "flex" }} color="white" alignItems={"center"} _hover={{ backgroundColor: "darkgrey", borderRadius: "10px" }} p={"10px"}><Link to="/buisness"><BusinessSetup /></Link><CiMenuKebab/></Text>
                    ...
                    <Link to="/Login"><Text color="white" _hover={{ cursor: "pointer",backgroundColor: "darkgrey", borderRadius: "10px" }} p={"10px"} display={{ base: "none", lg: "flex" }}>SIGN IN</Text></Link>
                    <Link to={"/Signup"}><Text color="white" _hover={{ cursor: "pointer", backgroundColor: "darkgrey", borderRadius: "10px" }} p={"10px"} display={{ base: "none", lg: "flex" }}>SIGN UP</Text></Link>
                    <Box display={{ base: "flex", lg: "none" }}>
                        <Menu>
                            ...
                            <MenuList>
                                ...
                                <MenuItem>
                                    {/* TRADEMARK AND IP */}
                                    <Link to="/trademark">BUSINESS COMPLIANCES </Link>
                                </MenuItem>
                                <MenuItem>
                                    <Link to="/income">INCOME TAX</Link>
                                </MenuItem>
                                <MenuItem>
                                    <Link to="/Software">SOFTWARE AND IT</Link>
                                </MenuItem>
                                <MenuItem>
                                    <Link to="/fund">
                                        {/* FUNDRAISING */}
