...
`
    ...
    return (
        ...
        // "rgb(1,37,70)"
        <Box minHeight={"600px"} backgroundColor="rgb(255,185,29)" color={"white"} padding={"5px"} boxShadow="rgba(60, 64, 67, 0.3) 0px 1px 2px 0px, rgba(60, 64, 67, 0.15) 0px 1px 3px 1px"
        ...
        >
            ...
            <Box boxShadow="rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset" p={"2px"} m={"10px"} >
                ...
                {/* <Link to={"/Sale"}> */}
                <HStack width={{ base: "20px", md: "180px", lg: "180px" }} marginTop={"8px"} cursor={"pointer"}
                    _hover={{
                        backgroundColor: "orange", borderRadius: "10px",
                    }} height={"35px"} boxShadow="rgba(0, 0, 0, 0.100) 0px 0px 0px 1px"
            ...
            <Box boxShadow="rgba(6, 24, 44, 0.4) 0px 0px 0px 2px, rgba(6, 24, 44, 0.65) 0px 4px 6px -1px, rgba(255, 255, 255, 0.08) 0px 1px 0px inset" p={"2px"} m={"10px"} >
                ...
                {/* /Online_Store */}
                <Link to={""}>
                    <HStack width={{ base: "20px", md: "180px", lg: "180px" }} marginTop={"8px"} p={"2px"} cursor={"pointer"} onClick={collapse4.onToggle}
                        _hover={{
                            backgroundColor: "orange", borderRadius: "10px",
                        }} height={"35px"} boxShadow="rgba(0, 0, 0, 0.100) 0px 0px 0px 1px">
