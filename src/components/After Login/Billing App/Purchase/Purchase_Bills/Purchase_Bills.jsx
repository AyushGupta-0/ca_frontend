...
const Purchase_Bills = () => {
    ...
    const calculateTotalPurchase_BillsAmount = () => {
        const Purchase_BillsAmounts = tableData.map((row) => {
            const amount = row.quantity * row.unitPrice;
            const taxAmount = (row.taxPercent / 100) * amount;
            return amount + taxAmount;
        });
        const totalPurchase_BillsAmount = Purchase_BillsAmounts.reduce((total, amount) => total + amount, 0);
        return totalPurchase_BillsAmount;
    };
                            ...
                            <Table >
                                ...
                                <Tfoot>
                                    <Tr>
                                        ...
                                        <Td colSpan="3"></Td>
                                        <Td>Total Purchase_Bills Amount: </Td>
                                        <Td>
                                            ₹{calculateTotalPurchase_BillsAmount()}
                                        </Td>
