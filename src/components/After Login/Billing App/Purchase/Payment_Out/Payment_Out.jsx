...
const Payment_Out = () => {
    ...
    const calculateTotalPayment_OutAmount = () => {
        const Payment_OutAmounts = tableData.map((row) => {
            const amount = row.quantity * row.unitPrice;
            const taxAmount = (row.taxPercent / 100) * amount;
            return amount + taxAmount;
        });
        const totalPayment_OutAmount = Payment_OutAmounts.reduce((total, amount) => total + amount, 0);
        return totalPayment_OutAmount;
    };
                            ...
                            <Table >
                                ...
                                <Tfoot>
                                    <Tr>
                                        ...
                                        <Td colSpan="3"></Td>
                                        <Td>Total Payment_Out Amount: </Td>
                                        <Td>
                                            ₹{calculateTotalPayment_OutAmount()}
                                        </Td>
