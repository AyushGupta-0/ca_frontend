    ...
    return (
        <Box position={"sticky"} top={"0px"} zIndex={"1"}>
            ...
            <Flex backgroundColor="#FFB91D" fontFamily="'Roboto', sans-serif" as="b" padding={{ base: " 10px 8%", lg: "10px 1%" }} justifyContent="space-between" alignItems="center" margin={"auto"}>
                ...
                <Text _hover={{ backgroundColor: "white", borderRadius: "10px" }} p={"10px"} display={{ base: "none", lg: "flex" }}><Link to="/buisness"><BusinessSetup /></Link></Text>
                <Text display={{ base: "none", lg: "flex" }} _hover={{ backgroundColor: "white", borderRadius: "10px" }} p={"10px"}><Link to="/tax"><TaxCompliance /></Link></Text>
                <Text display={{ base: "none", lg: "flex" }} _hover={{ backgroundColor: "white", borderRadius: "10px" }} p={"10px"}><Link to="/income"><IncomeTax /></Link></Text>
                <Text display={{ base: "none", lg: "flex" }} _hover={{ backgroundColor: "white", borderRadius: "10px" }} p={"10px"}><Link to="/trademark"><TrademarkIP /></Link></Text>
                <Text display={{ base: "none", lg: "flex" }} _hover={{ backgroundColor: "white", borderRadius: "10px" }} p={"10px"}><Link to="/ngo"><NGO /></Link></Text>
